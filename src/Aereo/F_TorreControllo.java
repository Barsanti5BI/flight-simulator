...
public class F_TorreControllo extends Thread{
    ...
    public void Add_Aereo(Aereo a){this.AereiInArrivo.push(a);}
    public void Crea_Viaggi(String dest,Aereo a){viaggi.put(a.Get_ID(),dest);}
    public void Set_Aereoporti(HashMap<String,F_TorreControllo> Ap){Aereoporti=Ap;}
    public void Set_Viaggi(HashMap<String ,String> v){viaggi = v;}
    public void setDestinazione(Aereo a) {a.Set_AP_Destinazione(viaggi.get(a.Get_ID()));}
}
